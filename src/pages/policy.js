...
export default function Policy() {
    ...
    return (
        <div className="page-transition">
            ...
            {/* Hero Section */}
            <HeroSection title="Privacy & Policy" theme="aboutus" previousPath={location.state?.from} />

            <div className="policy-container">
                <div className="policy-page">
                    <p className="policy-effective-date">Effective Date: January 1, 2025</p>
                    <p className="policy-intro">At Google Developers Group on Campus (GDG on Campus), we value your privacy and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, and safeguard information when you interact with our community, website, or events.</p>

                    <h2 className="policy-info">1. Information We Collect</h2>
                    ...
                    <h3>c. Event and Community Participation</h3>
                    <ul>
                    ...
                    <h2>9. Social Media and Third-Party Links</h2>
