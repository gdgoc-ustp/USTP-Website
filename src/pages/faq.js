          ...
          {faqs.map((faq, i) => {
            ...
            return (
              ...
              >
                <button
                  onClick={() => toggleFaq(i)}
                  className="w-full flex justify-between items-center p-5 text-left text-lg hover:bg-gray-50 transition-colors font-sans tracking-wide text-gray-800"
                >
                  <span>{faq.question}</span>
                  <span
                    className={`font-bold transform transition-transform duration-300 text-gray-500 ${
